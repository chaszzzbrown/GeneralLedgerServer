...
def grade(student_answers, correct_answers):
    ...
    for trans1 in student:
        ...
        for idx, trans2 in enumerate(correct):
            # logic valid unless both the student and correct answers have different duplicate entries;
            # but a correct answer never has a transaction with duplicate entries
